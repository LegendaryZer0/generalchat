...
public class ChatServerEndPoint {
  private static final Set<ChatServerEndPoint> sessionsEndpointsSet = new CopyOnWriteArraySet<>();
  ...
  public void setChatMessageContext(ChatMessageContext chatMessageContext) {
    ChatServerEndPoint.chatMessageContext = chatMessageContext;
  }
  ...
  public void onMessage(Session session, MessagesDto message) {
    ...
    messageService.recieveAndSaveStringMessage(message.converToMessage());
  }
